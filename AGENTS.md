...
- chrome dino / dinosaur → demo_dino (NOT Holo; Jev sees Runner numbers; code taps keys; Chromium; ask first; takes the keyboard; new key; macOS App Management for Terminal if it asks)
